...
public final class Sound1 implements Component, Clocked {
	...
	private enum NR11 implements Bit { S_LENGTH0, S_LENGTH1, S_LENGTH2, S_LENGTH3, S_LENGTH4, S_LENGTH5, DUTY1, DUTY2 }
	
	private enum NR12 implements Bit { LENGTH0, LENGTH1, LENGTH2, ENVELOPE, ENV_DEF1, ENV_DEF2, ENV_DEF3, ENV_DEF4 }
	...
	private int getWaveDuty() {
		return soundRegs.asInt(Reg.NR11, NR11.DUTY1, NR11.DUTY2);
	}
