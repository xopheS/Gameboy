...
public final class Joypad implements Component {
    ...
    private enum Key {RIGHT, LEFT, UP, DOWN, A, B, SELECT, START};
    ...
    public void keyPressed(Key k) {
        ...
        if(index < lineSize) Bits.set(line1, index, true);
        else Bits.set(line2, index % lineSize, true);   
        
        switch(Bits.extract(P1, 4, 2)) {
        case 0b00 : break;
        case 0b01 : P1 |= line1; break;
        case 0b10 : P1 |= line2; break;
        case 0b11 : P1 |= (line1 | line2);break;
        }
    ...
    public void keyReleased(Key k) {
        ...
        if(index < lineSize) Bits.set(line1, index, false);
        else Bits.set(line2, index % lineSize, false); 
