...
public final class Bits {
     ...
     *             (inclus) et 32 (exclus))
     */
    public static int mask(final int index) {
     ...
     *             (inclus) et 32 (exclus))
     */
    public static boolean test(final int bits, final int index) {
     ...
     *             (inclus) et 32 (exclus))
     */
    public static boolean test(final int bits, final Bit bit) {
    ...
    /**
     * Remplace le bit d'index donné d'un entier
     * par une nouvelle valeur (0 ou 1).
     *
     * @param bits
     *            entier à modifier
     * @param index
     ...
     *             (inclus) et 32 (exclus))
     */
    public static int set(final int bits, final int index,
     ...
     *             (inclus)
     */
    public static int clip(final int size, final int bits) {
     ...
     */
    public static int extract(final int bits, final int start, final int size) {
     ...
     */
    public static int rotate(final int size, final int bits, final int distance) {
     ...
     */
    public static int signExtend8(final int b) {
     ...
     *             si la valeur donnée n'est pas une valeur de 8 bits 
     */
    public static int reverse8(final int b) {
        int[] reverse = new int[] {
