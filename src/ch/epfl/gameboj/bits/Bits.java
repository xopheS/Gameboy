...
public final class Bits {
    private static final int[] reverse = new int[] { 0x00, 0x80, 0x40, 0xC0, 0x20, 0xA0, 0x60, 0xE0, 0x10, 0x90, 0x50, 0xD0, 0x30, 0xB0,
    ...
    public static int complement8(int b) {
        return Bits.clip(Byte.SIZE, ~Preconditions.checkBits8(b));
    }
