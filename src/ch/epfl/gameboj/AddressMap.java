...
public interface AddressMap {
    ...
    // Cartridge header
    int CARTRIDGE_HEADER_START = 0x0100, CARTRIDGE_HEADER_END = 0x0150,
            CARTRIDGE_HEADER_SIZE = CARTRIDGE_HEADER_END - CARTRIDGE_HEADER_START;
    ...
    int EXTERNAL_RAM_START = 0xA000, EXTERNAL_RAM_END = 0xC000,
            EXTERNAL_RAM_SIZE = EXTERNAL_RAM_END - EXTERNAL_RAM_START;
    // WRAM bank 0
    ...
    int WAVE_RAM_END = 0xFF40, WAVE_RAM_SIZE = WAVE_RAM_END - WAVE_RAM_START;
